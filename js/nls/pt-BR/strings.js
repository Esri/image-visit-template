define({
  ...
  "addFromFile": {
    ...
    "types": {
      ...
      "CSV": "Um Arquivo CSV (.csv, com endereço ou latitude, longitude e delimitado por vírgula, dois pontos ou barra)",
      "KML": "Um Arquivo KML (.kml)",
      "GPX": "Um Arquivo GPX (.gpx, Formato de Intercãmbio do GPS)",
      "GeoJSON": "Um Arquivo GeoJSON (.geo.json ou .geojson)"
    },
